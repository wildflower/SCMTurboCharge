select 
 champion_registry.icp,    champion_eiep1.reportmonth, meterregister,   champion_eiep1.units,    champion_eiep1.status,    champion_eiep1.retailer,    metercontact,
    ...
    champion_registry.retailer,    icpstatus,    icpcreationdate,    icpcommisiondate,        eventstart,    eventend,       addressuserref,     addressnumber,
    addressstreet,    addresstown,    metertypenhh,    metertypehhr,    distpricecat,    category
