SELECT 
    ...
    sunrise_eiep1.chargeabledays,    sunrise_eiep1.pricecode,    sunrise_eiep1.pricerate,    sunrise_eiep1.charge,
     sunrise_eiep1.retailer,chargeablecapacity, reference ,  addressuserref,    addressnumber,    addressstreet,    addresstown,    icpstatus,    category,    metertypehhr,    ami,
    meterregister
FROM
...
where
    sunrise_registry.icp = '1000013303BP1FD'
