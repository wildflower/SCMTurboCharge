SELECT 
    ...
    sunrise_eiep1.chargeabledays,    sunrise_eiep1.pricecode,    sunrise_eiep1.pricerate,    sunrise_eiep1.charge,
     sunrise_eiep1.retailer,sunrise_registry.retailer as 'Current Retailer',metercontact,meterregister,chargeablecapacity,     addressnumber,  
...
FROM
    ...
    where  sunrise_eiep1.icp ='1000000203BP2F8'
