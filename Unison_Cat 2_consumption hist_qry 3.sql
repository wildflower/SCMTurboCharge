...
addressuserref,    addressnumber,    addressstreet,    addresstown,    icpstatus,     
    distpricecat,    category 
 
from
    unison_eiep1
    inner join unison_registry on  unison_registry.icp = unison_eiep1.icp
    where unison_registry.category = '2' 
    and  unison_eiep1.fixedvariable= 'V'
