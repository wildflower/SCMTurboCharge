SELECT 
    ...
    champion_registry.retailer,    addressuserref,    addressnumber,    addressstreet,    addresstown,    icpstatus,    metertypenhh,
...
where
    champion_registry.icp = '0007730015WA06F ' and champion_eiep1.fixedvariable = 'V'
