...
sunrise_registry.icp,    sunrise_eiep1.reportmonth,    sunrise_eiep1.units,    sunrise_eiep1.status,    sunrise_eiep1.retailer,    metercontact,
    sunrise_eiep1.pricecode, sunrise_eiep1.fixedvariable,   sunrise_eiep1.pricerate,    sunrise_eiep1.charge,  sunrise_registry.retailer ,   addressuserref,    addressnumber,    addressstreet,
...
where   sunrise_eiep1.fixedvariable = 'V' and units = '0'  and icpstatus = '2' and sunrise_eiep1.reportmonth > '201109'
