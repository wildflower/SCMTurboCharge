 select sunrise_invoice.icp,distpricecat, sunrise_registry.icpstatus, sunrise_registry.icpstatusreason,
 ...
 and sunrise_eiep1.pricecode = sunrise_invoice.pricecode    inner join sunrise_registry on sunrise_registry.icp=sunrise_invoice.icp  
 
 
 where  
 sunrise_invoice.reportmonth > '201201'
  and sunrise_eiep1.retailer = 'PUNZ'
  and  sunrise_eiep1.fixedvariable = 'F'
  and sunrise_registry.icpstatus ='1'
